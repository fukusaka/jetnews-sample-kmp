...
@Composable
fun HorizontalPost(post: Post, bookmarks: Set<String>, onToggleBookmark: (String) -> Unit, modifier: GlanceModifier, showImageThumbnail: Boolean = true) {
...
@Composable
fun PostImage(imageId: DrawableResource, contentScale: ContentScale = ContentScale.Crop, modifier: GlanceModifier = GlanceModifier) {
    Image(
